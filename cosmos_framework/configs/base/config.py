...
def make_config() -> Config:
    ...
    # Register experiments explicitly. Auto-discover via
    # import_all_modules_from_package("cosmos_framework.configs.base.experiment", ...) would walk
    # the action posttrain_config subtree and try to import sibling files that
    # reference unshipped modules (camera_dataset/av_dataset/imaginaire.modules),
    # cascading into ModuleNotFoundError. Explicit imports avoid that.
    import cosmos_framework.configs.base.experiment.action.posttrain_config.libero_policy_datapacker_experiment  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_fdm_sft_nano  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_fdm_sft_super  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_policy_sft_nano  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_policy_sft_super  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_fdm_sft_nano_datapacker  # noqa: F401
    import cosmos_framework.configs.base.experiment.sft.action_policy_sft_nano_datapacker  # noqa: F401
