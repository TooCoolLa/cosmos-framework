...
paths, video-style loss scales, ``load_weights_from_pretrained=True``). Action
experiments override the divergent fields after deepcopy; see
``action_fdm_sft_nano`` / ``action_policy_sft_nano`` for the override list.
"""
