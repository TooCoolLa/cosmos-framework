...
Example (single node interactive run)::
    ...
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. torchrun --nproc_per_node=1 \
        --master_port=12347 cosmos_framework/scripts/train.py \
...
from cosmos_framework.data.vfm.action.hand_pose_dataset import HandPoseDataset
from cosmos_framework.data.vfm.action.hand_pose_dataset_config import HAND_POSE_DATASETS, EMBODIMENT_A_ALL
