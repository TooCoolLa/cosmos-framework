...
def single_view_joint_exp():
    """
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. torchrun --nproc_per_node=1 --master_port=12341 cosmos_framework/scripts/train.py --config=cosmos_framework/configs/base/config.py -- experiment=libero_exp_joint_single_view_lr2e4_60k
    """
...
def wrist_view_joint_exp():
    """
    CUDA_VISIBLE_DEVICES=0 PYTHONPATH=. torchrun --nproc_per_node=1 --master_port=12341 cosmos_framework/scripts/train.py --config=cosmos_framework/configs/base/config.py -- experiment=libero_exp_joint_wrist_view_lr2e4_60k
    """
