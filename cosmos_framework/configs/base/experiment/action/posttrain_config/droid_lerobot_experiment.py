...
from cosmos_framework.configs.base.experiment.action.pretrained_config.cosmos3_32b import make_32b_experiment
...
droid_lerobot_32b["model"]["config"]["vlm_config"]["pretrained_weights"]["enabled"] = False
