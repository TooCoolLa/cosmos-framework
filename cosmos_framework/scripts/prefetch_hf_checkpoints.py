...
def prefetch_all() -> None:
    ...
    for repo in [
        # 'imaginaire.auxiliary.guardrail.llamaGuard3.llamaGuard3',
        "meta-llama/Llama-Guard-3-8B",
        # 'imaginaire.auxiliary.guardrail.qwen3guard.qwen3guard',
        "Qwen/Qwen3Guard-Gen-0.6B",
        # 'imaginaire.auxiliary.guardrail.video_content_safety_filter.vision_encoder',
