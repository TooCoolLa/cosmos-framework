...
from cosmos_framework.data.vfm.action.umi.data_classes import (
    DataMeta,
    SourceDataMeta,
    construct_data_meta,
    construct_source_data_meta,
)
from cosmos_framework.data.vfm.action.umi.data_utils import aggregate_batch
from cosmos_framework.data.vfm.action.umi.imagecodecs_numcodecs import register_codecs
from cosmos_framework.data.vfm.action.umi.normalizer import FixedNormalizer
from cosmos_framework.data.vfm.action.umi.transforms import BaseTransforms
...
def get_umi_dataset(
    ...
    **kwargs,
    ...
    try:
        ...
        pass
    if dataset_type == "umi":
        cfg = OmegaConf.load("cosmos_framework/data/vfm/action/umi_dataset.yaml")
