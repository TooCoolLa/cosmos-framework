...
from cosmos_framework.data.vfm.action.embodiment_b_dataset_config import LEROBOT_ROOTS
...
class Embodiment_bDataset(BaseActionLeRobotDataset):
    ...
    def __init__(
        ...
        self._all_shard_roots = [f"<PATH_TO_DATASET>/{x}" for x in LEROBOT_ROOTS]
