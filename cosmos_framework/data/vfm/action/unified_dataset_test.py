...
from cosmos_framework.model.vfm.omni_mot_model_test import _maybe_init_distributed

"""
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_hare_niemeyer --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_assign_worker --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_iter --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_backward_compat --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_worker_init_fn --L0
pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_register_sources --L0
torchrun --nproc_per_node=4 --standalone -m pytest -v -s cosmos_framework/data/vfm/action/unified_dataset_test.py::test_distributed_4rank_shard_assignment --L1
"""
...
def test_worker_init_fn_calls_assign_worker():
    ...
    from cosmos_framework.data.vfm.action.dataloaders import create_action_worker_init_fn
    ...
    with patch("cosmos_framework.data.vfm.action.dataloaders.distributed") as mock_dist:
...
def test_distributed_4rank_shard_assignment():
    ...
    Run with:
        torchrun --nproc_per_node=4 --standalone -m pytest -v -s \\
            cosmos_framework/data/vfm/action/unified_dataset_test.py::test_distributed_4rank_shard_assignment --L1
    """
    ...
    from cosmos_framework.data.vfm.action.dataloaders import InfiniteDataLoader, create_action_worker_init_fn
