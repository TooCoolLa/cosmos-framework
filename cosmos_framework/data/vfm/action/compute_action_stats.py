...
Usage:
    ...
    PYTHONPATH=. python cosmos_framework/data/vfm/action/compute_action_stats.py \
        ...
        --split train \
        --max-samples 10000 \
        --output cosmos_framework/data/vfm/action/libero_action_stats_10k.json \
    ...
    PYTHONPATH=. python cosmos_framework/data/vfm/action/compute_action_stats.py \
        --config cosmos_framework/configs/base/config.py \
        --split train \
        --output cosmos_framework/data/vfm/action/pusht_action_stats.json \
...
from cosmos_framework.utils.context_managers import data_loader_init

# cosmos_framework/data/vfm/action/ => 5 levels up to repo root
