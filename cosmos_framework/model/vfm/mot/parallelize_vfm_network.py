...
from cosmos_framework.model.vfm.mot.parallelize_unified_mot import parallelize_unified_mot
...
def parallelize_vfm_network(
    ...
    Args:
        ...
        parallelism_config: Parallelism switches (FSDP degree, compile, AC on/off).
    ...
    if parallelism_config.use_torch_compile and parallelism_config.compiled_region == "all":
        model = apply_compile(model, parallelism_config)
