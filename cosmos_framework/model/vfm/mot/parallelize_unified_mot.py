...
def apply_compile(model: nn.Module, config: ParallelismConfig) -> None:
    """
...
def parallelize_unified_mot(
    ...
    Args:
        ...
        parallelism_config: Parallelism switches (FSDP degree, compile).
    ...
    if parallelism_config.use_torch_compile:
        apply_compile(model, parallelism_config)
