...
Concretely, this demo deliberately simplifies three things:

    1. NOISE SCHEDULE — uses a fixed σ = 0.5 every iter.
       Real training samples σ from a logit-normal (image) / waver (video)
       distribution per `OmniMoTModel._get_train_noise_level_vision`.
    2. LOSS — plain MSE on velocity.
       ...
       scaling).
    3. SAMPLER — plain Euler, no CFG, ~8 steps.
...
real loss + sampler when porting to your own framework.
...
================================================================================
    ...
    PYTHONPATH=. python examples/integration/net_level.py --checkpoint /path/to/dcp
"""
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default=None,
                        help="Local DCP/HF checkpoint dir; default downloads Cosmos3-Nano.")
    ...
    # 1) Load OmniMoTModel and grab the bare net ----------------------------
