...
================================================================================
    ...
    PYTHONPATH=. python examples/integration/trainer_level_training.py --checkpoint /path/to/dcp
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a local DCP checkpoint dir. If omitted, downloads the default checkpoint.",
    )
