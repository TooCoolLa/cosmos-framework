...
# Structured-TOML launch for action_fdm_sft_super (Bridge LeRobot FDM LoRA
# SFT on Qwen3-VL-32B-Instruct, 8-GPU FSDP with CP=2 / DP=4). Drives
# cosmos_framework.scripts.train against
# examples/toml/sft_config/action_fdm_sft_super.toml.
#
...
#   bash examples/launch_sft_action_fdm_super.sh

TOML_FILE="examples/toml/sft_config/action_fdm_sft_super.toml"
