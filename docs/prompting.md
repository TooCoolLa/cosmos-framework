...
Prompt upsampling is strongly recommended. We provide an [upsampling template](../cosmos_framework/inference/defaults/prompt_upsampler.txt) that is known to work well with [Qwen/Qwen3-VL-8B-Instruct-FP8](https://huggingface.co/Qwen/Qwen3-VL-8B-Instruct-FP8).
